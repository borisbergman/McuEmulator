    ...
    def mcuInterpreter(self):  # interpret command and reply
        ...
        # MCU Update
            ...
            if len(self.ReceivedData) == 35:
                ...
                print("FirePanel\t\t{0}".format(str(HelperMethods.int2hex(self.ReceivedData[6:14]))))
                print("Evacuation Panel\t\t{0}".format(str(HelperMethods.int2hex(self.ReceivedData[14:22]))))
                print("Fire Detection\t\t{0}".format(str(HelperMethods.int2hex(self.ReceivedData[22:30]))))
            else:
